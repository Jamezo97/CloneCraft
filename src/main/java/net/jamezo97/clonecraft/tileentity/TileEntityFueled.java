...
public abstract class TileEntityFueled extends CCTileEntityBase
{
	...
	/**
	 * Automatically start burning fuel and performing action when all
	...
	public void updateEntity()
	{
		...
		{
			// If no fuel is burning, and there is something new to burn, and
			// there is an action that can be performed, and it's allowed to
			// start cooking(or it already is)
	...
	/**
	 * Checks if the action can be performed (not including whether fuel is
	 * available to burn
	 * 
	 * @return
	 */
