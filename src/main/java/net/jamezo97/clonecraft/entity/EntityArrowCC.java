...
public class EntityArrowCC extends Entity implements IProjectile
{
    ...
    public EntityArrowCC(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityArrowCC(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityArrowCC(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityArrowCC(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (!movingobjectposition.entityHit.isEntityInvulnerable())
                    {
                        this.entityHit = movingobjectposition.entityHit;
                        this.setDead();
                    }
                    else
                    {
