...
//	    float scale = 0.0f;
	    ...
	    this.modelBreastLeft.addBox(
	    		-3.2f -	this.modelBreastLeft.rotationPointX, 
	    		2 - 	this.modelBreastLeft.rotationPointY,
	    		-3f - 	this.modelBreastLeft.rotationPointZ
	    		, 3, 3, 3, scale);
	    ...
	    this.modelBreastRight.addBox(
	    		0.2f -  this.modelBreastRight.rotationPointX, 
	    		2 - 	this.modelBreastRight.rotationPointY, 
	    		-3f - 	this.modelBreastRight.rotationPointZ, 
	    		3, 3, 3, scale);
		...
		if(p_78086_1_ instanceof EntityClone)
		{
			...
			if(clone.leftBParticle != null && clone.rightBParticle != null)
			{
				...
				
				{
					...
					this.modelBreastLeft.offsetZ =  scale * (0.09f);//0.09
...
//        System.out.println(p_78088_2_ + ": " + p_78088_3_);
