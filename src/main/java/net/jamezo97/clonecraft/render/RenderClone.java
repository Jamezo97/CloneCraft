...
public class RenderClone extends RendererLivingEntity
{
	...
	public void doRender(EntityClone clone, double xPos, double yPos, double zPos, float p_76986_8_, float p_76986_9_)
	{
		...
		{
			renderStatus(clone, Math.round(clone.getHealth()) + "/" + Math.round(clone.getMaxHealth()), clone.getHealth() / clone.getMaxHealth(), xPos, yPos,
					zPos, p_76986_9_, 0);
	...
	{
		/*
		 * float red = 0, green = 0, blue = 0; EntityClone clone =
		 * (EntityClone)entity; red = ((float)((clone.getCTeam().teamColour >>
		 * 16) & 0xff))/255.0f; green = ((float)((clone.getCTeam().teamColour >>
		 * 8) & 0xff))/255.0f; blue = ((float)((clone.getCTeam().teamColour) &
		 * 0xff))/255.0f;
		 */
	...
	protected void renderEquippedItems(EntityClone clone, float partial)
	{
		...
		if (s1 != null
				&& (s1 == null || s2 == null || s1.getItem() != s2.getItem() || s1.getItemDamage() != s2.getItemDamage() || s1.stackSize != s2.stackSize))
		{
	...
	public void renderItemstackInHand(ItemStack stack, int hand, EntityClone clone, float partial)
	{
		...
		net.minecraftforge.client.IItemRenderer customRenderer = net.minecraftforge.client.MinecraftForgeClient.getItemRenderer(stack,
				net.minecraftforge.client.IItemRenderer.ItemRenderType.EQUIPPED);
		boolean is3D = (customRenderer != null && customRenderer.shouldUseRenderHelper(net.minecraftforge.client.IItemRenderer.ItemRenderType.EQUIPPED, stack,
	...
	protected void func_96449_a(EntityClone p_96449_1_, double p_96449_2_, double p_96449_4_, double p_96449_6_, String p_96449_8_, float p_96449_9_,
			double p_96449_10_)
	{
		if (p_96449_10_ < 100.0D)
		{
			...
			if (scoreobjective != null)
			{
				...
				{
					this.func_147906_a(p_96449_1_, score.getScorePoints() + " " + scoreobjective.getDisplayName(), p_96449_2_, p_96449_4_ - 1.5D, p_96449_6_,
							64);
				}
				else
				{
	...
	protected void rotateCorpse(EntityClone p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
	{
		...
		// 0.0F);
		// GL11.glRotatef(this.getDeathMaxRotation(p_77043_1_), 0.0F, 0.0F,
		// 1.0F);
	...
	@Override
	protected void func_96449_a(EntityLivingBase p_96449_1_, double p_96449_2_, double p_96449_4_, double p_96449_6_, String p_96449_8_, float p_96449_9_,
			double p_96449_10_)
	{
