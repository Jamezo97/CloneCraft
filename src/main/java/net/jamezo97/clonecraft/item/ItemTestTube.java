...
public class ItemTestTube extends Item
{
	...
	public String getItemStackDisplayName(ItemStack stack)
	{
		...
		{
			return (data.isDirty() ? StatCollector.translateToLocal("cc.dirty") : StatCollector.translateToLocal("cc.empty")) + " "
					+ StatCollector.translateToLocal("cc.item.testTube.name");
		}
		else
		{
	...
	public void getSubItems(Item item, CreativeTabs tab, List list)
	{
		...
		if (tab == null || tab == CloneCraft.creativeTabAll)
		{
			...
			for (Entry<Integer, Class> entry : CCEntityList.idToClass.entrySet())
			{
				...
				if (((EntityLiving.class.isAssignableFrom(entityClass) || CloneCraftHelper.isValid(CCEntityList.classToString, entityClass)))
	...
	public CreativeTabs[] getCreativeTabs()
	{
		...
		{ CloneCraft.creativeTab, CloneCraft.creativeTabAll };
	}
