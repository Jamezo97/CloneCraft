...
public class GuiColourButton extends GuiButton{
	...
	public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_)
    {
        if (this.visible)
        {
            ...
            this.drawCenteredString(fontrenderer, this.displayString, (int)((this.xPosition + this.width / 2)/scaleText), (int)((this.yPosition + (this.height - (7*scaleText)) / 2)/scaleText), l);
