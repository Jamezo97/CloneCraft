...
public class ButtonCloneTeam extends GuiColourButton
{
	...
	public boolean mousePressed(Minecraft par1Minecraft, int par2, int par3)
	{
		...
		if (pressed)
		{
			...
			clone.getSyncer().sendValueToServer(Syncer.ID_TEAM);
		}
		return pressed;
	}
	...
	public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_)
	{
		if (this.selected)
		{
			...
			this.drawTriColourRectVert(this.xPosition - size, this.yPosition - size, this.xPosition + width + size, this.yPosition + height + size,
					this.xPosition + width / 2, 0xffff0000, 0xff00ff00, 0xff0000ff);

			// this.drawRect(this.xPosition-size, this.yPosition-size,
			// this.xPosition+width+size, this.yPosition+height+size,
			// colourSelected);
		}
