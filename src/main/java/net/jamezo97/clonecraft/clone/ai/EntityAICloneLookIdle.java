...
public class EntityAICloneLookIdle extends EntityAIBase
{
	...
	public void updateTask()
	{
		...
		{
			this.idleEntity.getLookHelper().setLookPosition(blockCoord.xPos + 0.5, blockCoord.yPos + 0.5, blockCoord.zPos + 0.5, 10.0F,
					(float) this.idleEntity.getVerticalFaceSpeed());
		}
		else
		{
			this.idleEntity.getLookHelper().setLookPosition(this.idleEntity.posX + this.lookX,
					this.idleEntity.posY + (double) this.idleEntity.getEyeHeight() + this.lookY, this.idleEntity.posZ + this.lookZ, 10.0F,
					(float) this.idleEntity.getVerticalFaceSpeed());
		}
