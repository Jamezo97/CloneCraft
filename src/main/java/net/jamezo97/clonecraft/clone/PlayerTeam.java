...
{
	Red(0, 0xff0000), Orange(1, 0xff8000), Yellow(2, 0xffff00), Green(3, 0x00ff00), Blue(4, 0x0000ff), LightBlue(5, 0x0080ff), Purple(6, 0xc800ff), Pink(7,
			0xffaaff), Good(8, 0xffffff), Evil(9, 0x555555), Rampant(10, 0x442222);
