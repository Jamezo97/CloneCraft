...
//		GL11.glDisable(GL11.GL_CULL_FACE);
		renderStatus(clone, "Percent Done", done, this.minX + (this.maxX-this.minX)/2, (this.maxY)+0.9, this.minZ + (this.maxZ-this.minZ)/2, p, (this.maxX-this.minX)>(this.maxZ-this.minZ)?(this.maxZ-this.minZ):(this.maxX-this.minX));
//		GL11.glEnable(GL11.GL_CULL_FACE);
	...
	public void renderStatus(EntityClone clone, String s, float done, double x, double y, double z, float partial, int width){
        ...
        if (d3 <= (double)(maxDistanceSqr))
        {
            ...
            fontrenderer.drawString(percent, -sWidth / 2, 0, 0xffffffff);
            fontrenderer.drawString(s, -fontrenderer.getStringWidth(s) / 2, -10, 0xffffffdd);
//            fontrenderer.drawString(percent, -fontrenderer.getStringWidth(percent) / 2, 0, -1);
//            fontrenderer.drawString(s, -fontrenderer.getStringWidth(s) / 2, -10, -1);
