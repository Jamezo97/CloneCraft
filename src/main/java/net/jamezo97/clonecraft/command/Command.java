...
/**
 * All Commands must be defined by a verb(/action). i.e. mine, dig, build, jump,
 * kill, come
 * 
 * @author James
 *
...
public abstract class Command
{
	...
	/**
	 * If these words are found in the command string, then it is more likely
	 * that this command is to be chosen to be executed.
	 * 
	...
	/**
	 * Gets the Parameters that define the subject of the command. i.e. Go kill
	 * some creepers
	 * 
	 * @return
	 */
